...
function generate_entries()
    ...
    for _, ds in ipairs(datasets.datasets) do
        ...
        image = (ds.imagePath and ds.imagePath ~= "")  
                and [[\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{]] .. ds.imagePath .. [[}]]
        ...
        contact = [[
            ...
            ]] ..  escape_latex(ds.useCases) .. [[
            \\[1em]
            \textbf{Download:} 
            \url{]] .. ds.downloadUrl .. [[} \\
            \begin{center}
                \qrcode[height=3cm]{]] .. escape_latex(ds.downloadUrl) .. [[}
            \end{center}
            \clearpage
            ]]
